...
DATABASE_NAME = 'shapes'
ROOT_DIR = os.path.join('datasets', DATABASE_NAME)
IMAGE_DIR = os.path.join(ROOT_DIR, "train/images")
ANNOTATION_DIR = os.path.join(ROOT_DIR,  "train/annotations")
...
def main():
    ...
    for root, _, files in os.walk(IMAGE_DIR):
        image_files = filter_for_images(root, files)
    ...
    with open(f'{ROOT_DIR}/{DATABASE_NAME}.json', 'w') as output_json_file:
